...
class Bantec_Nav_Menu extends Widget_Base
{
    public function get_name()
    {
        return 'bantec_nav_menu';
    }

    public function get_title()
    {
        return esc_html__('Nav Menu - Bantec', 'bantec-toolkit');
    }
    ...
    {
        return ['bantec', 'Menu', 'Builder', 'Header', 'nav'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'style_section',
            [
                'label' => esc_html__('Deaktop Nav Style', 'bantec-toolkit'),
        ...
        $this->add_control(
            'menu_height',
            [
                'label' => esc_html__('Menu Space', 'bantec-toolkit'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header_nav-menu ul li .sub-menu' => 'border-style: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header_nav-menu ul li .sub-menu' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'submenu_border_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header_nav-menu ul li .sub-menu' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'submenu_border_type!' => '',
                ],
...
Plugin::instance()->widgets_manager->register(new Bantec_Nav_Menu);