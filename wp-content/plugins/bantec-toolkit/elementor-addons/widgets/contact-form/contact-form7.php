...
if (!defined('ABSPATH'))
    exit;
class Bantec_Contact_Form7 extends Widget_Base
{

    public function get_name()
    {
        return 'bantec-contact-form7';
    }

    public function get_title()
    {
        return esc_html__('Contact Form 7 - Bantec', 'bantec-toolkit');
    }

    public function get_icon()
    {
        return 'bantec-icon eicon-mail';
    }
    ...
    {
        return ['bantec', 'Toolkit', 'Form', 'Contact'];
    }
    public function bantec_contact_forms(){
        $formlist = array();
        ...
        if( $forms ){
            ...
            $formlist['0'] = esc_html__('Form not found','bantec-toolkit');
        }
        return $formlist;
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'contactform_content',
            [
                'label' => esc_html__('Contact Form', 'bantec-toolkit'),
            ]
        );
        $this->add_control(
            'contact_form_id',
            [
                'label' => esc_html__('Select Form', 'bantec-toolkit'),
                'type' => Controls_Manager::SELECT,
                'label_block' => true,
                'options' => $this->bantec_contact_forms(),
                'default' => '0',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bantec-contact-form-wrapper',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'justify' => [
                        'title' => esc_html__('Justified', 'bantec-toolkit'),
                        'icon' => 'eicon-text-align-justify',
                    ],
                ],
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper' => 'text-align: {{VALUE}};',
                ],
                'default' => 'left',
                'separator' => 'before',
            ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input', 'bantec-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Background Color', 'bantec-toolkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Placeholder Color', 'bantec-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'input_focus_color',
            [
                'label' => esc_html__('Focus Border Color', 'bantec-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Textarea', 'bantec-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Label', 'bantec-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper form.wpcf7-form label' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper form.wpcf7-form label' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bantec-contact-form-wrapper form.wpcf7-form label',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper form.wpcf7-form label' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper form.wpcf7-form label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .bantec-contact-form-wrapper form.wpcf7-form label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
    ...
    protected function render($instance = [])
    {
        ...
        $this->add_render_attribute('bantec_wpform_attr', 'class', 'bantec-contact-form-wrapper');
        ...
        ?>
        <div <?php echo $this->get_render_attribute_string('bantec_wpform_attr'); ?>>
            <?php
            if (!empty($settings['contact_form_id'])) {
                echo do_shortcode($shortcode);
            } else {
                echo '<div class="bantec_form_no_select">' . esc_html__('Please Select contact form.', 'bantec-toolkit') . '</div>';
            }
            ?>
        </div>
...
Plugin::instance()->widgets_manager->register(new Bantec_Contact_Form7());