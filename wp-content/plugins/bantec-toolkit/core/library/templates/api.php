...
class Api extends Source_Base {
	...
	const LIBRARY_OPTION_KEY = 'bantec_toolkit_library_info';

	const LIBRARY_TIMESTAMP_CACHE_KEY = 'bantec_toolkit_remote_update_timestamp';

	const API_INFO_URL = 'https://library.themeori.com/bantec/';

	public function get_id() {
		return 'bantec-toolkit-library';
	}

	public function get_title() {
		return esc_html__( 'Bantec Library', 'bantec-toolkit' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'bantec-toolkit' ) );
		}
