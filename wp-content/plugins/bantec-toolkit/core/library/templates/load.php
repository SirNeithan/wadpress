...
use \Bantec_Toolkit\templates\Templates as Init;
use \Bantec_Toolkit\templates\Api as Api;
...
class Load{
    ...
    public function register_ajax_actions( Ajax $ajax ) {
        $ajax->register_ajax_action( 'get_bantec_toolkit_library_data', function( $data ) {
